# first open source python file exstension
# its like .exe but you dont need to be a verified publisher to run
# have fun making new encrypted programs and progects 
# the .devk exstension is a new opensource python based program maker
